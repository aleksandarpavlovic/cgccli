...
public class ParserTest {
    ...
    public void testParseCommand(String[] tokens, Command expected) {
    ...
    public Object[][] wellStructuredCommands() {
        ...
        Command.Builder commandBuilder1 = new Command.Builder();
        Command expected1 = commandBuilder1.withOption(option1).withOperation(operationBuilder1.build()).build();
        ...
        Command.Builder commandBuilder2 = new Command.Builder();
        Command expected2 = commandBuilder2.withOption(option2_1).withOperation(operationBuilder2.build()).build();
        ...
        Command.Builder commandBuilder3 = new Command.Builder();
        Command expected3 = commandBuilder3.withOperation(operationBuilder3.build()).build();
        ...
        Command.Builder commandBuilder4 = new Command.Builder();
        Command expected4 = commandBuilder4.withOption(option4_1).withOperation(operationBuilder4.build()).build();
